...
<div class="container">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && !isset($_POST['action'])) {
        ...
        if (!$isDuplicate || $status == "aguardando") {
            ...
            $entregas[] = $dados;
            file_put_contents($file, json_encode($entregas));
        }
...
<div class="buttons">
    <button onclick="window.print()" class="btn-green">Imprimir Lista</button>
    <button onclick="window.location.href='index.php'" class="btn-green">Voltar para Página Inicial</button>
</div>
